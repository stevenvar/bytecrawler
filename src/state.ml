...
let string_of_instr = function
  ...
  | GETGLOBAL n               ->  "GETRAMGLOBAL"
  | PUSHGETGLOBAL n           ->  "PUSHGETRAMGLOBAL"
  | GETGLOBALFIELD (n, p)     ->  "GETRAMGLOBALFIELD"
  | PUSHGETGLOBALFIELD (n, p) ->  "PUSHGETRAMGLOBALFIELD"
  | SETGLOBAL n               ->  "SETRAMGLOBAL"
  | ATOM0                     ->  "ATOM0"
  | ATOM tag                  ->  "ATOM"
  | PUSHATOM0                 ->  "PUSHATOM0"
